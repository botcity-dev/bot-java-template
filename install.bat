call mvn install:install-file -Dfile=lib/botcity-framework-core-1.3.0.jar -DgroupId=dev.botcity -DartifactId=botcity-framework-core -Dversion=1.3.0 -Dpackaging=jar
...
call mvn install:install-file -Dfile=lib/maestro-sdk-1.2.1.jar -DgroupId=dev.botcity -DartifactId=maestro-sdk -Dversion=1.2.1 -Dpackaging=jar